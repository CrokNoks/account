    ...
    Papa.parse(file, {
      ...
      complete: async (results: any) => {
        try {
          ...
          notify(translate('resources.expenses.notifications.import_success', { count: expensesToInsert.length }), { type: 'success' });
          refresh();
        } catch (error: any) {
          console.error('Import error:', error);
          notify(translate('resources.expenses.notifications.import_error', { error: error.message }), { type: 'error' });
        } finally {
          setLoading(false);
