CREATE OR REPLACE FUNCTION get_evolution_data(p_account_id UUID, p_category_type TEXT DEFAULT NULL)
RETURNS TABLE (
  period_id UUID,
  period_start DATE,
  period_end DATE,
...
BEGIN
  ...
  WHERE p.account_id = p_account_id
    AND (p_category_type IS NULL OR c.type = p_category_type OR c.type IS NULL)
